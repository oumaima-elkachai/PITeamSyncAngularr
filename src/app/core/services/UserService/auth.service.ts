...
export class AuthService {
  ...
  unblockUser(userId: string): Observable<any> {
    return this.http.put(`${this.baseUrl}/unblock/${userId}`, {}, { withCredentials: true });
  }
  ...
  blockUser(userId: string): Observable<any> {
    // Here we assume your backend expects a PUT request to block a user.
    return this.http.put(`${this.baseUrl}/block/${userId}`, {}, { withCredentials: true });
  }  
